...
const Route = (props: { component: (props: any) => JSX.Element; props: { [key: string]: any } }) => {
...
export const RouteDefault = (props: {
  ...
  const components = useMemo(() => props.components.map((c) => <Route key={c.key} component={c.component} props={c.props ?? {}} />), [
    props.components
  ]);
